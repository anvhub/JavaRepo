package excelread; 
 ...
 { 
 	...
 	{ 
 		f=new FileInputStream("C:\\Users\\aruno\\Documents\\Obsqura\\JAN 08 JAVA(Aiswarya)\\ExcelRead.xlsx");//to access the file from the given location 
 	...
 	{ 
 		f=new FileInputStream("C:\\Users\\aruno\\Documents\\Obsqura\\JAN 08 JAVA(Aiswarya)\\ExcelRead.xlsx"); 
